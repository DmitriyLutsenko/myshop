                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-flex align-items-center p-0 border-0 flex-column justify-content-center">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="{{ asset('assets/images/banner/menu-banner.png') }}" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
            ...
            <div class="inner">
                ...
                <div class="body customScroll">
                    <ul class="minicart-product-list">
                        <li>
                            <a href="single-product.html" class="image"><img src="{{ asset('assets/images/product-image/1.webp') }}" alt="Cart product Image"></a>
                            <div class="content">
                        ...
                        <li>
                            <a href="single-product.html" class="image"><img src="{{ asset('assets/images/product-image/2.webp') }}" alt="Cart product Image"></a>
                            <div class="content">
                        ...
                        <li>
                            <a href="single-product.html" class="image"><img src="{{ asset('assets/images/product-image/3.webp') }}" alt="Cart product Image"></a>
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single-banner nth-child-2 mb-lm-30px">
                            <img src="{{ asset('assets/images/banner/6.webp') }}" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="single-banner nth-child-2">
                            <img src="{{ asset('assets/images/banner/7.webp') }}" alt="">
                        ...
                        <div class="row mb-n-30px">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            ...
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/1.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            ...
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/3.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('assets/images/product-image/5.webp') }}" alt="Product" />
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/5.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('assets/images/product-image/6.webp') }}" alt="Product" />
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/6.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('assets/images/product-image/7.webp') }}" alt="Product" />
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/1.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                ...
                                <div class="product">
                                    ...
                                    <div class="thumb">
                                        <a href="single-product.html" class="image">
                                            <img src="{{ asset('assets/images/product-image/8.webp') }}" alt="Product" />
                                            <img class="hover-image" src="{{ asset('assets/images/product-image/8.webp') }}" alt="Product" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <span class="category"><a href="#">Accessories</a></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single-banner mb-lm-30px">
                            <img src="{{ asset('assets/images/banner/8.webp') }}" alt="">
                            <div class="banner-content nth-child-3">
                    ...
                    <div class="col-md-6">
                        <div class="single-banner">
                            <img src="{{ asset('assets/images/banner/9.webp') }}" alt="">
                            <div class="banner-content nth-child-2">
                                <h3 class="title">Smart Watch For <br>
                                        Your Hand</h3>
                                <span class="category">From $95.00</span>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide feature-right-content">
                            <div class="image-side">
                                <img src="{{ asset('assets/images/feature-image/2.webp') }}" alt="">
                                <button title="Add To Cart" class="action add-to-cart" data-bs-toggle="modal" data-bs-target="#exampleModal-Cart"><i
                                    class="pe-7s-shopbag"></i></button>
                            </div>
                        ...
                        <div class="swiper-slide feature-right-content">
                            <div class="image-side">
                                <img src="{{ asset('assets/images/feature-image/3.webp') }}" alt="">
                                <button title="Add To Cart" class="action add-to-cart" data-bs-toggle="modal" data-bs-target="#exampleModal-Cart"><i
                                    class="pe-7s-shopbag"></i></button>
                            </div>
                            <div class="content-side">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 mb-xs-30px">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a href="blog-single-left-sidebar.html"><img src="{{ asset('assets/images/blog-image/1.webp') }}" class="img-responsive w-100" alt=""></a>
                            </div>
                            <div class="blog-text">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a href="blog-single-left-sidebar.html"><img src="{{ asset('assets/images/blog-image/2.webp') }}" class="img-responsive w-100" alt=""></a>
                            </div>
                            <div class="blog-text">
                                <div class="blog-athor-date line-height-1">
                                    <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                            ...
                            <div class="swiper-container gallery-top">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/zoom-image/1.webp') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/zoom-image/2.webp') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/zoom-image/3.webp') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/zoom-image/4.webp') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/zoom-image/5.webp') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-container gallery-thumbs mt-20px slider-nav-style-1 small-nav">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/small-image/4.webp') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{ asset('assets/images/product-image/small-image/5.webp') }}" alt="">
                                    </div>
                                </div>
                                <!-- Add Arrows -->
                                <div class="swiper-buttons">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="tt-modal-product">
                        <div class="tt-img">
                            <img src="{{ asset('assets/images/product-image/1.webp') }}" alt="Modern Smart Phone">
                        </div>
